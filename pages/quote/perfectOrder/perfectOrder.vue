<template>
	<view class="home">
		...
		<view class="center">
			...
			<view class="padding solid-bottom" v-if="addressStat" @tap="toSetDelivery">
			...
			<view class="cu-form-group solid-bottom">
				...
				<view class="flex align-center text-right">
					<text class="text-price">{{map.quote.total}}</text>
				</view>
			</view>
			<view class="cu-form-group solid-bottom">
				<view class="title"></view>
				<view class="flex align-center text-right">
					实付金额:<text class=" text-red">￥{{map.quote.total}}</text>
				</view>
			</view>
			<view class="padding-bottom-xs bg-grey light"></view>
			<view class="cu-form-group solid-bottom">
		...
		<view class="head padding text-center align-center justify-center solid-bottom solids-top margin-top">
			<button class="cu-btn bg-blue lg" @tap="next">提交订单</button>
		</view>
	</view>
</template>
