	...
	<view class="home">
		...
		<view class="head justify-between solid-bottom" @tap="toSetCustomer" v-if="but">
			...
			<view class="cu-bar margin-xs radius">
				<text class="cuIcon-title text-red"></text><text class="text-grey">编辑</text>
				<text class="cuIcon-right text-gray"></text>
			</view>
		</view>
		<view class="center" v-if="but">
			<view v-if="!show">
				<view class="line-view solid-bottom solid-top">
					<text class="border-title ">车辆信息</text>
				</view>
				...
				<view>
					...
					<view class="line-view solid-bottom solid-top">
						<text class="border-title ">去年投保信息</text>
					</view>
					...
					<view class="view-table">
						<view class="div-table">
							...
							<view class="tr" v-for="(item) in detail.insurance">
			...
			<view v-if="show">
				...
				<view>
					...
					<view v-if="map.insuredInfo==null" class="padding flex justify-center">
						未获取到投保信息
					</view>
				</view>
			</view>
		...
		<view v-if="!but" class="whirte text-sl radius" @tap="toFollow">
			<text class="cuIcon-add bg-blue"></text>
		</view>
	</view>
</template>
