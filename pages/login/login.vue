<template>
	<view class="home">
		<form>
			<view class="text-xxl flex justify-center padding-bottom">用户登录</view>
			...
			<view class="title">验证码</view>
				<m-input type="password" v-model="code" placeholder="请输入验证码"></m-input>
				<image src="http://baozhishun.com:8008/account/info/gifCode" class="img"></image>
			</view> -->
		</form>
		...
		<view class="btn-row">
			<!-- <button type="primary" open-type="getUserInfo" class="primary" @tap="bindLogin">登录</button> -->
